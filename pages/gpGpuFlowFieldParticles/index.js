...
gltf.useDraco();
const boatGltf = await gltf.loader.loadAsync(import.meta.resolve("./static/model.glb"));
/**
 * Base geometry
 */
const baseGeometry = {
    instance: boatGltf.scene.children[0].geometry,
    count: boatGltf.scene.children[0].geometry.attributes.position.count
};
